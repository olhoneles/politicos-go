...
func (c Cand2014) GetYear() int {
	return 2014
}

func (c *Cand2014) New(record []string) {
	...
	c.NR_DESPESA_MAX_CAMPANHA = record[51]
...
func (c Cand2014) GetCollectionName() string {
	return "candidatures"
}
